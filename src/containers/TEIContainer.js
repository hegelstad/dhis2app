        ...
        if (this.props.TeiData.length == 0 || !this.props.cursor) {
            ...
            return (
                <div>
                    ...
                    <Button bsStyle="warning" onClick={this.showAccordion} className="datepicker"> Basic Search</Button>
                    ...
                    { this.state.showAccordion
                        ...
                        <div>
                            <br />
                            <AccordionList
                                input={teiDuplicateFinder(this.props.TeiData, this.state.deepSearch)}
                                columns={Columns}
                            />
                        </div>
                        :
